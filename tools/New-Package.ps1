...
.LINK
    https://github.com/vedantmgoyal2009/vedantmgoyal2009/blob/main/tools/New-Package.ps1
#>
...
Process {
    ...
    $PackageJsonPath = "$PSScriptRoot\..\src\winget-pkgs-automation\packages\$($Package.Identifier.Substring(0,1).ToLower())\$($Package.Identifier.ToLower()).json"
