...
Invoke-WebRequest -Uri https://github.com/russellbanks/Komac/releases/download/v1.6.0/Komac-1.6.0-all.jar -OutFile .\komac.jar # Download latest version of Komac
