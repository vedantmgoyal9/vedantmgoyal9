...
func SubmitManifests(pkg_id, version string, manifests []WinGetManifest, commitType CommitType, forkUser string, reuseDraftPr bool, rmReason ...string) {
	...
	if os.Getenv("GITHUB_ACTION_REPOSITORY") == "vedantmgoyal2009/winget-releaser" {
		pullRequestBody.WriteString("### Pull request has been created with [WinGet Releaser v2](https://github.com/vedantmgoyal2009/winget-releaser) 🚀\n")
	} else if os.Getenv("GITHUB_REPOSITORY") == "vedantmgoyal2009/winget-pkgs-automation" || os.Getenv("GITHUB_REPOSITORY") == "vedantmgoyal2009/vedantmgoyal2009" {
