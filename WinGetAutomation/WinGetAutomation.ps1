...
Function Update-Manifest {
    ...
    & $script:WingetCreateExe $params | Tee-Object -Variable Null
    ...
    If (-not $DryRun -and $UpdateInfo.PSObject.Properties.Where({ $_.Name -in @('ProductCode', 'AppsAndFeaturesEntries', 'Locales') }).Count -ge 1) {
        ...
        & $script:WingetCreateExe submit $ManifestsPath --token $env:WINGETCREATE_TOKEN | Tee-Object -Variable Null
    }
}
#endregion
