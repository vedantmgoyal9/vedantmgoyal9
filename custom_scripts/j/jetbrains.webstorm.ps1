$result = Invoke-WebRequest -Headers $header -Uri "https://data.services.jetbrains.com/products/releases?latest=true&type=release&code=WS" -UseBasicParsing -Method Get | ConvertFrom-Json | Select-Object -ExpandProperty WS
