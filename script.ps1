...
foreach ($package in $packages) {
    $urls.Clear()
    $result = Invoke-RestMethod -Headers $header -Uri "https://api.github.com/repos/$($package.repo)/releases" -UseBasicParsing | Select-Object name,tag_name,assets,prerelease | Select-Object -First 1
