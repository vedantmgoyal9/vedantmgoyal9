...
if ($versionFromInstallerUrl -gt $package.last_checked_tag)
{
    ...
    $32exe = Invoke-RestMethod -Uri "https://teams.microsoft.com/desktopclient/installer/windows/x32?ring=general"
    $32msi = $32exe -replace "exe","msi"
    $arm64exe = Invoke-RestMethod -Uri "https://teams.microsoft.com/desktopclient/installer/windows/arm64?ring=general"
